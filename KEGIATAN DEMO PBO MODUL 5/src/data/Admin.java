...
public class Admin extends Main.User implements iMenu {
    ...
    public void login() {
        ...
        try {
            if (isAdmin(username, password)) {
                ...
                System.out.println("User Admin tidak ditemukan, karena anda penyusup");
            }
    ...
    private boolean isAdmin(String username, String password) throws IllegalAdminAcces {
        if (!username.equals("admin") || !password.equals("adminslot99")) {
