...
public  class Admin extends Main.User {
    ...
    public void login() {
        ...
        if (isAdmin(username, password)) {
            ...
            System.out.println("User Admin tidak ditemukan, karena sudah milik orang lain");
        }
    }
    ...
    private void inputBook() {
        ...
        switch (bookType) {
            case 1:
                ...
                Main.bookList.add(new HistoryBook(idBuku, judul, stok, author));
                break;
            case 2:
                idBuku = generateId("SB");
                Main.bookList.add(new StoryBook(idBuku, judul, stok, author));
                break;
            case 3:
                idBuku = generateId("TB");
                Main.bookList.add(new TextBook(idBuku, judul, stok, author));
                break;
            default:
