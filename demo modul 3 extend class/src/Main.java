...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        bookList.add(0, new Book("001", "Petani menyembelih Banteng", 5, "Jokowi"));
        bookList.add(1, new Book("002", "Banteng Merah", 10, "Megawati"));
        bookList.add(2, new Book("003", "Amin for Indonesia", 8, "Anies"));
